...
DEF CARD_DATA_ID                      RB     ; $07

; non-TYPE_PKMN card only
DEF CARD_DATA_EFFECT_COMMANDS         RW     ; $08
DEF CARD_DATA_NONPKMN_DESCRIPTION     RW 2   ; $0a

DEF TRN_CARD_DATA_LENGTH             EQU _RS ; $0e
DEF ENERGY_CARD_DATA_LENGTH          EQU _RS ; $0e

; TYPE_PKMN card only
RSSET CARD_DATA_ID + 1
DEF CARD_DATA_HP                      RB     ; $08
DEF CARD_DATA_STAGE                   RB     ; $09
DEF CARD_DATA_PREEVO_NAME             RW     ; $0a

DEF CARD_DATA_ATTACK1                EQU _RS ; $0c
DEF CARD_DATA_ATTACK1_ENERGY_COST     RB 4   ; $0c, NUM_TYPES / 2
DEF CARD_DATA_ATTACK1_NAME            RW     ; $10
DEF CARD_DATA_ATTACK1_DESCRIPTION     RW 2   ; $12
DEF CARD_DATA_ATTACK1_DAMAGE          RB     ; $16
DEF CARD_DATA_ATTACK1_CATEGORY        RB     ; $17
DEF CARD_DATA_ATTACK1_EFFECT_COMMANDS RW     ; $18
DEF CARD_DATA_ATTACK1_FLAG1           RB     ; $1a
DEF CARD_DATA_ATTACK1_FLAG2           RB     ; $1b
DEF CARD_DATA_ATTACK1_FLAG3           RB     ; $1c
DEF CARD_DATA_ATTACK1_EFFECT_PARAM    RB     ; $1d
DEF CARD_DATA_ATTACK1_ANIMATION       RB     ; $1e

DEF CARD_DATA_ATTACK2                EQU _RS ; $1f
DEF CARD_DATA_ATTACK2_ENERGY_COST     RB 4   ; $1f, NUM_TYPES / 2
DEF CARD_DATA_ATTACK2_NAME            RW     ; $23
DEF CARD_DATA_ATTACK2_DESCRIPTION     RW 2   ; $25
DEF CARD_DATA_ATTACK2_DAMAGE          RB     ; $29
DEF CARD_DATA_ATTACK2_CATEGORY        RB     ; $2a
DEF CARD_DATA_ATTACK2_EFFECT_COMMANDS RW     ; $2b
DEF CARD_DATA_ATTACK2_FLAG1           RB     ; $2d
DEF CARD_DATA_ATTACK2_FLAG2           RB     ; $2e
DEF CARD_DATA_ATTACK2_FLAG3           RB     ; $2f
DEF CARD_DATA_ATTACK2_EFFECT_PARAM    RB     ; $30
DEF CARD_DATA_ATTACK2_ANIMATION       RB     ; $31

DEF CARD_DATA_RETREAT_COST            RB     ; $32
DEF CARD_DATA_WEAKNESS                RB     ; $33
DEF CARD_DATA_RESISTANCE              RB     ; $34
DEF CARD_DATA_CATEGORY                RW     ; $35
DEF CARD_DATA_POKEDEX_NUMBER          RB     ; $37
DEF CARD_DATA_UNUSED                  RB     ; $38
DEF CARD_DATA_LEVEL                   RB     ; $39
DEF CARD_DATA_LENGTH                  RW     ; $3a
DEF CARD_DATA_WEIGHT                  RW     ; $3c
DEF CARD_DATA_PKMN_DESCRIPTION        RW     ; $3e
DEF CARD_DATA_AI_INFO                 RB     ; $40

DEF PKMN_CARD_DATA_LENGTH            EQU _RS ; $41
