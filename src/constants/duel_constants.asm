...
DEF SAVE_DUEL_DATA              RB 826 ; $4
DEF SAVE_DUEL_DATA_SIZE         EQU _RS - SAVE_DUEL_HEADER_SIZE ; 826
DEF SAVE_DUEL_SIZE              EQU _RS ; 830
...
DEF TURN_DUELIST_PLAY_AREA     EQU $0
DEF NON_TURN_DUELIST_PLAY_AREA EQU $1
