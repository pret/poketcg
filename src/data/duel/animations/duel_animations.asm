...
Animations:
	...
	db PALETTE_PARALYSIS ; palette ID
	...
	db PALETTE_LIGHTNING ; palette ID
	...
	db PALETTE_BIG_LIGHTNING ; palette ID
	...
	db PALETTE_FIRE_SPIN ; palette ID
	...
	db PALETTE_FIRE_BIRD ; palette ID
	...
	db PALETTE_WATER_DROP ; palette ID
	...
	db PALETTE_WATER_GUN ; palette ID
	...
	db PALETTE_WHIRLPOOL ; palette ID
	...
	db PALETTE_HYDRO_PUMP ; palette ID
	...
	db PALETTE_HYPER_BEAM ; palette ID
	...
	db PALETTE_ROCK_THROW ; palette ID
	...
	db PALETTE_STRETCH_KICK ; palette ID
	...
	db PALETTE_SONICBOOM ; palette ID
	...
	db PALETTE_WHITE_GAS ; palette ID
	...
	db PALETTE_SMALL_STAR ; palette ID
	...
	db PALETTE_WHIRLWIND ; palette ID
	...
	db PALETTE_QUESTION_MARK ; palette ID
	...
	db PALETTE_EXPLOSION ; palette ID
	...
	; DUEL_ANIM_DARK_GAS
	db SPRITE_DUEL_GAS ; sprite ID
	db PALETTE_DARK_GAS ; palette ID
	db SPRITE_ANIM_129 ; anim ID
	db NONE ; anim flags
	...
	db PALETTE_SMALL_GLOW ; palette ID
